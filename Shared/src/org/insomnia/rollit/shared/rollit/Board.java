...
public final class Board {
	...
	public Board() {
		...
		for(int x = 0; x < BOARD_WIDTH; x++) {
			for(int y = 0; y < BOARD_HEIGHT; y++) {
				// The constructor of socket initializes to Ball.None so we don't have to explicitly set it to be empty.
	...
	/**
	 * Counts all balls of a given type and returns the result.
	 * This method can also be used to count empty sockets by calling it with <code>Ball.None</code>.
