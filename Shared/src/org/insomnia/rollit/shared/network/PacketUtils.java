...
public final class PacketUtils {
	...
	private static final ByteBuffer BYTE_BUFFER = ByteBuffer.allocate(BIGGEST_SIZE);
	...
	public static short toShort(byte[] buffer, int offset, AtomicInteger bytesRead) {
		...
		BYTE_BUFFER.put(buffer, offset, SHORT_SIZE);
		BYTE_BUFFER.flip();

		ShortBuffer shortBuffer = BYTE_BUFFER.asShortBuffer();
	...
	public static char toChar(byte[] buffer, int offset, AtomicInteger bytesRead) {
		...
		BYTE_BUFFER.put(buffer, offset, CHAR_SIZE);
		BYTE_BUFFER.flip();

		CharBuffer charBuffer = BYTE_BUFFER.asCharBuffer();
	...
	public static int toInt(byte[] buffer, int offset, AtomicInteger bytesRead) {
		...
		BYTE_BUFFER.put(buffer, offset, INT_SIZE);
		BYTE_BUFFER.flip();

		IntBuffer intBuffer = BYTE_BUFFER.asIntBuffer();
	...
	public static float toFloat(byte[] buffer, int offset, AtomicInteger bytesRead) {
		...
		BYTE_BUFFER.put(buffer, offset, FLOAT_SIZE);
		BYTE_BUFFER.flip();

		FloatBuffer floatBuffer = BYTE_BUFFER.asFloatBuffer();
	...
	public static long toLong(byte[] buffer, int offset, AtomicInteger bytesRead) {
		...
		BYTE_BUFFER.put(buffer, offset, LONG_SIZE);
		BYTE_BUFFER.flip();

		LongBuffer longBuffer = BYTE_BUFFER.asLongBuffer();
	...
	public static double toDouble(byte[] buffer, int offset, AtomicInteger bytesRead) {
		...
		BYTE_BUFFER.put(buffer, offset, DOUBLE_SIZE);
		BYTE_BUFFER.flip();

		DoubleBuffer doubleBuffer = BYTE_BUFFER.asDoubleBuffer();
